...
@Component({
    selector: 'swd-wild-horizons',
    templateUrl: 'wild-horizons.component.html',
    styleUrls: ['wild-horizons.component.scss'],
})
export class WildHorizonsComponent {
    ...
    importCards() {
        const url =
            'https://docs.google.com/spreadsheets/d/e/2PACX-1vTOWSUVSfCFrnN8H3mJ8XSEwbjBaANTW6_' +
            'Pwdcu8e0qymd_TUUwRGNlmvYYg3Ibi0MitJ1MJh49nm4d/pub?gid=0&single=true&output=csv';
        if (url) {
            this.cardCollection = [];
